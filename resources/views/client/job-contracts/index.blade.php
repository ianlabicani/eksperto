...
@section('client-content')
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-4">
                ...
                <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden">
                    ...
                    <div class="card-body d-flex align-items-center ps-4">
                        ...
                        <div class="ms-2 ms-sm-3">
                            ...
                            <h3 class="card-title mb-0 fw-bold h4 h-sm-3">{{ $jobContracts->where('status', 'active')->count() }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden">
                    ...
                    <div class="card-body d-flex align-items-center ps-4">
                        ...
                        <div class="ms-2 ms-sm-3">
                            ...
                            <h3 class="card-title mb-0 fw-bold h4 h-sm-3">{{ $jobContracts->where('status', 'pending')->count() }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden">
                    ...
                    <div class="card-body d-flex align-items-center ps-4">
                        ...
                        <div class="ms-2 ms-sm-3">
                            ...
                            <h3 class="card-title mb-0 fw-bold h4 h-sm-3">{{ $jobContracts->where('status', 'completed')->count() }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-6 col-lg-3">
                <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden">
                    <div class="position-absolute bg-danger bg-opacity-10" style="width: 8px; height: 100%; left: 0; top: 0;"></div>
                    <div class="card-body d-flex align-items-center ps-4">
                        ...
                        <div class="ms-2 ms-sm-3">
                            ...
                            <h3 class="card-title mb-0 fw-bold h4 h-sm-3">{{ $jobContracts->where('status', 'cancelled')->count() }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <ul class="nav nav-tabs flex-nowrap" id="contractTabs" role="tablist" style="min-width: 500px;">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="active-tab" data-bs-toggle="tab" data-status="active">
                        Active <span class="badge rounded-pill bg-success ms-1">{{ $jobContracts->where('status', 'active')->count() }}</span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pending-tab" data-bs-toggle="tab" data-status="pending">
                        Pending <span class="badge rounded-pill bg-warning ms-1">{{ $jobContracts->where('status', 'pending')->count() }}</span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="completed-tab" data-bs-toggle="tab" data-status="completed">
                        Completed <span class="badge rounded-pill bg-info ms-1">{{ $jobContracts->where('status', 'completed')->count() }}</span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="cancelled-tab" data-bs-toggle="tab" data-status="cancelled">
                        Cancelled <span class="badge rounded-pill bg-danger ms-1">{{ $jobContracts->where('status', 'cancelled')->count() }}</span>
                    </button>
                </li>
            </ul>
        </div>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                ...
                                <div class="text-muted small">
                                    to {{ $jobContract->end_date ? \Carbon\Carbon::parse($jobContract->end_date)->format('M d, Y') : 'Ongoing' }}
                                </div>
                            </div>
                        </div>
                                ...
                                @forelse($jobContracts as $jobContract)
                                    <tr class="contract-row" data-status="{{ $jobContract->status }}">
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            <div class="text-muted small">{{ $jobContract->jobApplication->jobListing->category }}</div>
                                        </td>
                                        <td class="px-4 py-3">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-5">
                                            <div class="py-5">
                                                ...
                                                <a href="{{ route('client.job-contracts.create') }}" class="btn btn-primary mt-3">
                                                    <i class="fas fa-plus me-1"></i> Create Contract
                                                </a>
                                            </div>
                                        </td>
