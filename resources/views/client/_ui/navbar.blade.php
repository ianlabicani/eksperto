    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.job-listings.index') ? 'active' : '' }}"
                        href="{{ route('client.job-listings.index') }}">
                        <i class="fas fa-briefcase"></i> Jobs
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.job-applications.index') ? 'active' : '' }}"
                        href="{{ route('client.job-applications.index') }}">
                        <i class="fas fa-file-alt"></i> Applicants
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('client.job-contracts.index') ? 'active' : '' }}"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li>
                            <a class="dropdown-item {{ request()->routeIs('client.profile.index') ? 'active' : '' }}"
