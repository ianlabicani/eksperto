        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item mx-1">
                    <a class="nav-link px-3 py-2 rounded-pill transition-all {{ request()->routeIs('client.dashboard') ? 'active bg-primary bg-opacity-10 fw-medium text-light' : '' }}"
                ...
                <li class="nav-item mx-1">
                    <a class="nav-link px-3 py-2 rounded-pill transition-all {{ request()->routeIs('client.job-listings.*') ? 'active bg-primary bg-opacity-10 fw-medium text-light' : '' }}"
                        href="{{ route('client.job-listings.index') }}">
                        <i class="fas fa-briefcase me-2 opacity-75"></i>My Jobs
                    </a>
                </li>
                <li class="nav-item mx-1">
                    <a class="nav-link px-3 py-2 rounded-pill transition-all {{ request()->routeIs('client.job-applications.*') ? 'active bg-primary bg-opacity-10 fw-medium text-light' : '' }}"
                        href="{{ route('client.job-applications.index') }}">
                        <i class="fas fa-file-alt me-2 opacity-75"></i>Applications
                    </a>
                </li>
                <li class="nav-item mx-1">
                    <a class="nav-link px-3 py-2 rounded-pill transition-all {{ request()->routeIs('client.job-contracts.*') ? 'active bg-primary bg-opacity-10 fw-medium text-light' : '' }}"
                ...
                @php
                    $profileRoutes = ['client.profile.index'];
                @endphp
                <!-- Profile Dropdown -->
                <li class="nav-item dropdown ms-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end border-0 rounded-4 mt-2 p-2"
                        ...
                        <li>
                            <a class="dropdown-item py-2 px-3 rounded-3 mb-1 {{ request()->routeIs('client.profile.index') ? 'active' : '' }}"
