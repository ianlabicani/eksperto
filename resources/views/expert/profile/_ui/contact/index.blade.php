...
<button class="btn btn-sm btn-outline-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#updateContactModal">
    <i class="fas fa-edit me-1"></i> Manage Contacts
</button>
...
@push('scripts')
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var contactIndex = {{ $user->contacts ? $user->contacts->count() : 1 }};
